#
#  Be sure to run `pod spec lint async.swift.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Luavis" => "luaviskang@gmail.com" }
  # Or just: s.author    = "Luavis"
  # s.authors            = { "Luavis" => "luaviskang@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Luavis"
